...
@Getter
public class CollectionNode extends OperableNode
{
    
    public static CollectionNode GLOBAL_NODE = new CollectionNode(null, null, null, null);
    ...
    protected CollectionNode(
            final @Nullable List<OperableNode> expressions,
    ...
    @NotNull
    @Override
    public CollectionNode parseAST(final @NotNull ArkoiNode parentAST) {
