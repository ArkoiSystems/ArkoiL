...
import com.arkoisystems.arkoicompiler.stage.parser.ast.types.operable.types.expression.types.operators.LogicalOperatorType;
...
public class LogicalExpressionNode extends ExpressionNode
{
    ...
    public static LogicalExpressionNode GLOBAL_NODE = new LogicalExpressionNode(null, null, null, null, null, null);
    ...
    @Nullable
    private final LogicalOperatorType operatorType;
    ...
    protected LogicalExpressionNode(
            final @Nullable LogicalOperatorType operatorType,
        ...
        super(parser, null, ASTType.LOGICAL_EXPRESSION, startToken, endToken);
    ...
    @NotNull
    @Override
    public LogicalExpressionNode parseAST(final @NotNull ArkoiNode parentAST) {
        return null;
    }
