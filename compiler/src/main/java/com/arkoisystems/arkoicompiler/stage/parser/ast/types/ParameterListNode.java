...
@Getter
public class ParameterListNode extends ArkoiNode
{
    
    public static ParameterListNode GLOBAL_NODE = new ParameterListNode(null, null, null);
    ...
    @NotNull
    @Override
    public ParameterListNode parseAST(final @NotNull ArkoiNode parentAST) {
