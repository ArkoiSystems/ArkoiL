...
import com.arkoisystems.arkoicompiler.stage.parser.marker.ArkoiMarker;
...
public class ArkoiASTNode implements IASTNode
{
    ...
    @Getter
    @NotNull
    private final MarkerFactory<ArkoiToken, ArkoiToken> markerFactory;
    ...
    public void startAST(@Nullable final ArkoiToken token) {
        if(token == null)
            return;
    ...
    public void endAST(@Nullable final ArkoiToken token) {
        if(token == null)
            return;
