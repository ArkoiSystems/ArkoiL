...
import com.arkoisystems.arkoicompiler.stage.parser.parsers.ArgumentParser;
...
public class ArgumentAST extends ArkoiASTNode
{
    ...
    @Getter
    @Nullable
    private ArkoiToken argumentName;
    ...
    private ArgumentAST(
            ...
            @Nullable final ArkoiToken argumentName,
    ...
    public ArgumentAST parseAST(@NotNull final IASTNode parentAST) {
        ...
        if (this.getSyntaxAnalyzer().matchesCurrentToken(TokenType.IDENTIFIER) == null) {
            ...
            return this.addError(
                    ...
                    "Argument", "<identifier>", currentToken != null ? currentToken.getData() : "nothing"
            );
        }
    
        this.startAST(this.getSyntaxAnalyzer().currentToken());
        this.argumentName = this.getSyntaxAnalyzer().currentToken();
        ...
        if (this.getSyntaxAnalyzer().matchesPeekToken(1, OperatorType.EQUALS) == null) {
            ...
            return this.addError(
                    ...
                    SyntaxErrorType.SYNTAX_ERROR_TEMPLATE,
                    "Argument", "'='", peekedToken != null ? peekedToken.getData() : "nothing"
            );
        }
        ...
        if (!ExpressionAST.EXPRESSION_PARSER.canParse(parentAST, this.getSyntaxAnalyzer())) {
            ...
            return this.addError(
                    ...
                    SyntaxErrorType.SYNTAX_ERROR_TEMPLATE,
                    "Argument", "<expression>", currentToken != null ? currentToken.getData() : "nothing"
            );
        }
