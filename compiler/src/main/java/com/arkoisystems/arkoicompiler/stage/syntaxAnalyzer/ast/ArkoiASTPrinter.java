...
public class ArkoiASTPrinter implements IVisitor<IASTNode>
{
    ...
    public TypeAST visit(@NotNull final TypeAST typeAST) {
        ...
        Objects.requireNonNull(typeAST.getTypeKeywordToken().getTypeKind(), "typeAST.typeKeywordToken.typeKind must not be null.");
        
        this.printFactory(typeAST);
        this.getPrintStream().printf("%s└── keyword: %s%s%n", this.getIndents(), typeAST.getTypeKeywordToken().getTypeKind().name(), typeAST.isArray() ? "[]" : "");
        return typeAST;
    }
    ...
    public ParameterAST visit(@NotNull final ParameterAST parameterAST) {
        ...
        this.getPrintStream().printf("%s├── name: %s%n", this.getIndents(), parameterAST.getParameterName().getTokenContent());
    ...
    public ArgumentAST visit(@NotNull final ArgumentAST argumentAST) {
        ...
        this.getPrintStream().printf("%s├── name: %s%n", this.getIndents(), argumentAST.getArgumentName().getTokenContent());
    ...
    public AnnotationAST visit(@NotNull final AnnotationAST annotationAST) {
        ...
        this.getPrintStream().printf("%s├── name: %s%n", this.getIndents(), annotationAST.getAnnotationName().getTokenContent());
    ...
    public FunctionAST visit(@NotNull final FunctionAST functionAST) {
        ...
        this.getPrintStream().printf("%s│%n", this.getIndents());
        this.getPrintStream().printf("%s├── name: %s%n", this.getIndents(), functionAST.getFunctionName().getTokenContent());
        this.getPrintStream().printf("%s├── type: %n", this.getIndents());
    ...
    public ImportAST visit(@NotNull final ImportAST importAST) {
        ...
        this.getPrintStream().printf("%s├── name: %s%n", this.getIndents(), importAST.getImportName().getTokenContent());
        this.getPrintStream().printf("%s└── path: %s%n", this.getIndents(), importAST.getImportFilePath().getTokenContent());
        return importAST;
    }
    ...
    public VariableAST visit(@NotNull final VariableAST variableAST) {
        ...
        this.getPrintStream().printf("%s├── name: %s%n", indents, variableAST.getVariableName().getTokenContent());
        this.getPrintStream().printf("%s│%n", indents);
    ...
    public StringAST visit(@NotNull final StringAST stringAST) {
        ...
        this.getPrintStream().printf("%s└── operable: %s%n", this.getIndents(), stringAST.getStringToken().getTokenContent());
        return stringAST;
    }
    ...
    public NumberAST visit(@NotNull final NumberAST numberAST) {
        ...
        this.getPrintStream().printf("%s└── operable: %s%n", this.getIndents(), numberAST.getNumberToken().getTokenContent());
        return numberAST;
    }
