...
@Getter
public class ArgumentListNode extends ArkoiNode
{
    ...
    @NotNull
    @Override
    public ArgumentListNode parseAST(final @NotNull ArkoiNode parentAST) {
        ...
        while (this.getParser().getPosition() < this.getParser().getTokens().length) {
            ...
            final ArgumentNode argumentAST = ArgumentNode.builder()
