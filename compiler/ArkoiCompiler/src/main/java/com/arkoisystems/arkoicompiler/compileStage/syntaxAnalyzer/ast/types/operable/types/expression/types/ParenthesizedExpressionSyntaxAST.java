...
public class ParenthesizedExpressionSyntaxAST extends AbstractExpressionSyntaxAST
{
    ...
    @Expose
    private final AbstractExpressionSyntaxAST abstractExpressionAST;
    
    @Expose
    private final SymbolToken closeParenthesisToken;
    
    public ParenthesizedExpressionSyntaxAST(final SymbolToken openParenthesisToken, final AbstractExpressionSyntaxAST abstractExpressionAST, final SymbolToken closeParenthesisToken) {
