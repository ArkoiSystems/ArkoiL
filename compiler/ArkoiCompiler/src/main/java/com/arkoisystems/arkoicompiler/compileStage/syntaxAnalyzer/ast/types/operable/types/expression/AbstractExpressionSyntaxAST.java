package com.arkoisystems.arkoicompiler.compileStage.syntaxAnalyzer.ast.types.operable.types.expression;
...
import com.arkoisystems.arkoicompiler.compileStage.syntaxAnalyzer.ast.types.operable.types.expression.types.*;
...
public class AbstractExpressionSyntaxAST extends AbstractOperableSyntaxAST<TypeSyntaxAST.TypeKind>
{
    ...
    private AbstractOperableSyntaxAST<?> parseAssignment(final SyntaxAnalyzer syntaxAnalyzer) {
        ...
        if (equal_second && syntaxAnalyzer.matchesPeekToken(1, SymbolToken.SymbolType.PLUS) != null) {
            ...
            final AbstractOperableSyntaxAST<?> rightSideAST = this.parseLogicalOr(syntaxAnalyzer);
            if (rightSideAST == null)
                return null;
            
            leftSideAST = new AssignmentExpressionSyntaxAST(leftSideAST, AssignmentExpressionSyntaxAST.AssignmentOperator.ADD_ASSIGN, rightSideAST);
            ...
            leftSideAST = new AssignmentExpressionSyntaxAST(leftSideAST, AssignmentExpressionSyntaxAST.AssignmentOperator.SUB_ASSIGN, rightSideAST);
            ...
            leftSideAST = new AssignmentExpressionSyntaxAST(leftSideAST, AssignmentExpressionSyntaxAST.AssignmentOperator.MUL_ASSIGN, rightSideAST);
            ...
            leftSideAST = new AssignmentExpressionSyntaxAST(leftSideAST, AssignmentExpressionSyntaxAST.AssignmentOperator.DIV_ASSIGN, rightSideAST);
            ...
            leftSideAST = new AssignmentExpressionSyntaxAST(leftSideAST, AssignmentExpressionSyntaxAST.AssignmentOperator.MOD_ASSIGN, rightSideAST);
            ...
            leftSideAST = new AssignmentExpressionSyntaxAST(leftSideAST, AssignmentExpressionSyntaxAST.AssignmentOperator.ASSIGN, rightSideAST);
        }
        return leftSideAST;
    }
    ...
    private AbstractOperableSyntaxAST<?> parseLogicalOr(final SyntaxAnalyzer syntaxAnalyzer) {
        ...
        if (syntaxAnalyzer.matchesPeekToken(1, SymbolToken.SymbolType.VERTICAL_BAR) != null && syntaxAnalyzer.matchesPeekToken(2, SymbolToken.SymbolType.VERTICAL_BAR) != null) {
            ...
            final AbstractOperableSyntaxAST<?> rightSideAST = this.parseLogicalAnd(syntaxAnalyzer);
            if (rightSideAST == null)
                return null;
            
            leftSideAST = new LogicalExpressionSyntaxAST(leftSideAST, LogicalExpressionSyntaxAST.LogicalOperator.LOGICAL_OR, rightSideAST);
        }
        return leftSideAST;
    }
    ...
    private AbstractOperableSyntaxAST<?> parseLogicalAnd(final SyntaxAnalyzer syntaxAnalyzer) {
        ...
        if (syntaxAnalyzer.matchesPeekToken(1, SymbolToken.SymbolType.AMPERSAND) != null && syntaxAnalyzer.matchesPeekToken(2, SymbolToken.SymbolType.AMPERSAND) != null) {
            ...
            final AbstractOperableSyntaxAST<?> rightSideAST = this.parseEquality(syntaxAnalyzer);
            if (rightSideAST == null)
                return null;
            
            leftSideAST = new LogicalExpressionSyntaxAST(leftSideAST, LogicalExpressionSyntaxAST.LogicalOperator.LOGICAL_AND, rightSideAST);
        }
        return leftSideAST;
    }
    ...
    private AbstractOperableSyntaxAST<?> parseEquality(final SyntaxAnalyzer syntaxAnalyzer) {
        ...
        if (syntaxAnalyzer.matchesPeekToken(1, SymbolToken.SymbolType.EQUAL) != null && syntaxAnalyzer.matchesPeekToken(2, SymbolToken.SymbolType.EQUAL) != null) {
            ...
            final AbstractOperableSyntaxAST<?> rightSideAST = this.parseRelational(syntaxAnalyzer);
            if (rightSideAST == null)
                return null;
            
            leftSideAST = new EqualityExpressionSyntaxAST(leftSideAST, EqualityExpressionSyntaxAST.EqualityOperator.EQUAL, rightSideAST);
            ...
            leftSideAST = new EqualityExpressionSyntaxAST(leftSideAST, EqualityExpressionSyntaxAST.EqualityOperator.NOT_EQUAL, rightSideAST);
        }
        return leftSideAST;
    }
    ...
    private AbstractOperableSyntaxAST<?> parseRelational(final SyntaxAnalyzer syntaxAnalyzer) {
        ...
        if (syntaxAnalyzer.matchesPeekToken(1, SymbolToken.SymbolType.LESS_THAN_SIGN) != null && equal_second) {
            ...
            final AbstractOperableSyntaxAST<?> rightSideAST = this.parseAdditive(syntaxAnalyzer);
            if (rightSideAST == null)
                return null;
            
            leftSideAST = new RelationalExpressionSyntaxAST(leftSideAST, RelationalExpressionSyntaxAST.RelationalOperator.LESS_EQUAL_THAN, rightSideAST);
            ...
            leftSideAST = new RelationalExpressionSyntaxAST(leftSideAST, RelationalExpressionSyntaxAST.RelationalOperator.GREATER_EQUAL_THAN, rightSideAST);
            ...
            leftSideAST = new RelationalExpressionSyntaxAST(leftSideAST, RelationalExpressionSyntaxAST.RelationalOperator.GREATER_THAN, rightSideAST);
        } else if (syntaxAnalyzer.matchesPeekToken(1, SymbolToken.SymbolType.GREATER_THAN_SIGN) != null) {
            syntaxAnalyzer.nextToken(3);
            ...
            leftSideAST = new RelationalExpressionSyntaxAST(leftSideAST, RelationalExpressionSyntaxAST.RelationalOperator.LESS_THAN, rightSideAST);
            ...
            leftSideAST = new RelationalExpressionSyntaxAST(leftSideAST, RelationalExpressionSyntaxAST.RelationalOperator.IS, rightSideAST);
        }
        return leftSideAST;
    }
    ...
    private AbstractOperableSyntaxAST<?> parseAdditive(final SyntaxAnalyzer syntaxAnalyzer) {
        ...
        if (syntaxAnalyzer.matchesPeekToken(1, SymbolToken.SymbolType.PLUS) != null) {
            ...
            final AbstractOperableSyntaxAST<?> rightSideAST = this.parseMultiplicative(syntaxAnalyzer);
            if (rightSideAST == null)
                return null;
            
            leftSideAST = new BinaryExpressionSyntaxAST(leftSideAST, BinaryExpressionSyntaxAST.BinaryOperator.ADDITION, rightSideAST);
            ...
            leftSideAST = new BinaryExpressionSyntaxAST(leftSideAST, BinaryExpressionSyntaxAST.BinaryOperator.SUBTRACTION, rightSideAST);
        }
        return leftSideAST;
    }
    ...
    private AbstractOperableSyntaxAST<?> parseMultiplicative(final SyntaxAnalyzer syntaxAnalyzer) {
        ...
        if (syntaxAnalyzer.matchesPeekToken(1, SymbolToken.SymbolType.ASTERISK) != null) {
            ...
            final AbstractOperableSyntaxAST<?> rightSideAST = this.parseUnary(syntaxAnalyzer);
            if (rightSideAST == null)
                return null;
            
            leftSideAST = new BinaryExpressionSyntaxAST(leftSideAST, BinaryExpressionSyntaxAST.BinaryOperator.MULTIPLICATION, rightSideAST);
            ...
            leftSideAST = new BinaryExpressionSyntaxAST(leftSideAST, BinaryExpressionSyntaxAST.BinaryOperator.DIVISION, rightSideAST);
            ...
            leftSideAST = new BinaryExpressionSyntaxAST(leftSideAST, BinaryExpressionSyntaxAST.BinaryOperator.MODULO, rightSideAST);
        }
        return leftSideAST;
    }
    ...
    private AbstractOperableSyntaxAST<?> parseUnary(final SyntaxAnalyzer syntaxAnalyzer) {
        if (syntaxAnalyzer.matchesCurrentToken(SymbolToken.SymbolType.PLUS) != null && syntaxAnalyzer.matchesPeekToken(1, SymbolToken.SymbolType.PLUS) != null) {
            ...
            final AbstractOperableSyntaxAST<?> rightSideAST = this.parseParenthesis(syntaxAnalyzer);
            if (rightSideAST == null)
                return null;
            return new PrefixExpressionSyntaxAST(rightSideAST, PrefixExpressionSyntaxAST.PrefixUnaryOperator.PREFIX_ADD, start);
            ...
            if (rightSideAST == null)
                return null;
            return new PrefixExpressionSyntaxAST(rightSideAST, PrefixExpressionSyntaxAST.PrefixUnaryOperator.PREFIX_SUB, start);
            ...
            if (rightSideAST == null)
                return null;
            return new PrefixExpressionSyntaxAST(rightSideAST, PrefixExpressionSyntaxAST.PrefixUnaryOperator.AFFIRM, start);
            ...
            if (rightSideAST == null)
                return null;
            return new PrefixExpressionSyntaxAST(rightSideAST, PrefixExpressionSyntaxAST.PrefixUnaryOperator.NEGATE, start);
