...
public class IdentifierCallOperableSemanticAST extends AbstractOperableSemanticAST<IdentifierCallOperableSyntaxAST, TypeSyntaxAST.TypeKind>
{
    ...
    public IdentifierCallOperableSemanticAST(final AbstractSemanticAST<?> lastContainerAST, final IdentifierCallOperableSyntaxAST identifierCallOperableSyntaxAST) {
        super(lastContainerAST, identifierCallOperableSyntaxAST, ASTType.IDENTIFIER_CALL_OPERABLE);
    }
    
    @Override
    public IdentifierCallOperableSemanticAST analyse(final SemanticAnalyzer semanticAnalyzer) {
        return null;
    }
