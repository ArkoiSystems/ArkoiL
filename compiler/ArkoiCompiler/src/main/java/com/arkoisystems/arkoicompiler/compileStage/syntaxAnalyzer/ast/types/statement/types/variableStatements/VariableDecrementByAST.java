...
@Getter
@Setter
public class VariableDecrementByAST extends VariableStatementAST
{
    
    @Expose
    private final VariableDefinitionAST variableDefinitionAST;
    
    public VariableDecrementByAST(final VariableDefinitionAST variableDefinitionAST) {
        super(ASTType.VARIABLE_DECREMENT_BY);
    
        this.variableDefinitionAST = variableDefinitionAST;
    }
    
    @Override
    public VariableDecrementByAST parseAST(final AbstractAST parentAST, final SyntaxAnalyzer syntaxAnalyzer) {
