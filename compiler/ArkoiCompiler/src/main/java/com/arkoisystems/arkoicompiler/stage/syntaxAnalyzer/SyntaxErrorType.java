...
public class SyntaxErrorType
{
    ...
    public static final String ARGUMENT_NO_SEPARATOR                                  = "Couldn't parse the argument definition because the argument name isn't followed by a colon.";
    public static final String ARGUMENT_NO_VALID_TYPE                                 = "Couldn't parse the argument definition because the colon isn't followed by a valid type.";
    ...
    public static String EXPRESSION_PARENTHESIZED_WRONG_START                         = "Couldn't parse the parenthesized expression because it doesn't start with an opening parenthesis.";
