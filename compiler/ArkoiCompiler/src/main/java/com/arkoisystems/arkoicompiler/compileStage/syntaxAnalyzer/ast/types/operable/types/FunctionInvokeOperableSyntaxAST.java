...
public class FunctionInvokeOperableSyntaxAST extends AbstractOperableSyntaxAST<TypeSyntaxAST.TypeKind>
{
    ...
    @Expose
    private final List<AbstractExpressionSyntaxAST> invokedArguments;
     ...
     */
    public FunctionInvokeOperableSyntaxAST(final IdentifierToken invokedFunctionNameToken, final FunctionInvocation functionInvocation) {
     ...
     *         The function IdentifierToken which is used for the name of the function.
     */
    public FunctionInvokeOperableSyntaxAST(final IdentifierToken invokedFunctionNameToken) {
        super(ASTType.FUNCTION_INVOKE_OPERABLE);
