...
public class ExpressionSyntaxAST extends AbstractExpressionSyntaxAST
{
    ...
    @Expose
    private final AbstractOperableSyntaxAST<?> abstractOperableSyntaxAST;
    
    public ExpressionSyntaxAST(final AbstractOperableSyntaxAST<?> abstractOperableSyntaxAST) {
        super(ASTType.BASIC_EXPRESSION);
        
        this.abstractOperableSyntaxAST = abstractOperableSyntaxAST;
        
        this.setStart(abstractOperableSyntaxAST.getStart());
        this.setEnd(abstractOperableSyntaxAST.getEnd());
    }
