...
@Getter
@Setter
public class VariableMultiplyByAST  extends VariableStatementAST
{
    
    @Expose
    private final VariableDefinitionAST variableDefinitionAST;
    
    public VariableMultiplyByAST(final VariableDefinitionAST variableDefinitionAST) {
        super(ASTType.VARIABLE_MULTIPLY_BY);
    
        this.variableDefinitionAST = variableDefinitionAST;
    }
    
    @Override
    public VariableMultiplyByAST parseAST(final AbstractAST parentAST, final SyntaxAnalyzer syntaxAnalyzer) {
