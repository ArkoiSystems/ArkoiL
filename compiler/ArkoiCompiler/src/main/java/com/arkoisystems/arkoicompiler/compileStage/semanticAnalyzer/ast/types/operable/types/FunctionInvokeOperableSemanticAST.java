...
public class FunctionInvokeOperableSemanticAST extends AbstractOperableSemanticAST<FunctionInvokeOperableSyntaxAST, TypeSyntaxAST.TypeKind>
{
    ...
    public FunctionInvokeOperableSemanticAST(final AbstractSemanticAST<?> lastContainerAST, final FunctionInvokeOperableSyntaxAST functionInvokeOperableSyntaxAST) {
        super(lastContainerAST, functionInvokeOperableSyntaxAST, ASTType.FUNCTION_INVOKE_OPERABLE);
    }
    
    @Override
    public FunctionInvokeOperableSemanticAST analyse(final SemanticAnalyzer semanticAnalyzer) {
        return null;
    }
