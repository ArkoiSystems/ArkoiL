...
public class AnnotationSemanticAST extends AbstractSemanticAST<AnnotationSyntaxAST>
{
    ...
    public AnnotationSemanticAST(final AbstractSemanticAST<?> lastContainerAST, final AnnotationSyntaxAST annotationSyntaxAST) {
        super(lastContainerAST, annotationSyntaxAST, ASTType.ANNOTATION);
    }
    
    @Override
    public AnnotationSemanticAST analyse(final SemanticAnalyzer semanticAnalyzer) {
        return null;
    }
