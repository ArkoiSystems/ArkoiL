...
import com.arkoisystems.arkoicompiler.compileStage.semanticAnalyzer.semantic.types.operable.types.expressions.ExpressionSemantic;
...
public class ExpressionAST extends AbstractExpressionAST<ExpressionSemantic>
{
    ...
    @Expose
    private final AbstractOperableAST<?, ?> abstractAST;
    
    public ExpressionAST(final AbstractOperableAST<?, ?> abstractAST) {
