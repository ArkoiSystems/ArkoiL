...
*/
@Getter
public class AbstractExpressionAST<S extends AbstractSemantic<?>> extends AbstractOperableAST<TypeAST.TypeKind, S>
{
    ...
    private ExpressionAST parseExpression(final SyntaxAnalyzer syntaxAnalyzer) {
        final AbstractOperableAST<?, ?> abstractAST = this.parseAssignment(syntaxAnalyzer);
        if (abstractAST == null)
            return null;
    ...
    // 10. assignment (= += -= *= /= %=)
    private AbstractOperableAST<?, ?> parseAssignment(final SyntaxAnalyzer syntaxAnalyzer) {
        AbstractOperableAST<?, ?> leftSideAST = this.parseLogicalOr(syntaxAnalyzer);
        if (leftSideAST == null)
            return null;
        ...
        if (equal_second && syntaxAnalyzer.matchesPeekToken(1, SymbolToken.SymbolType.PLUS) != null) {
            ...
            final AbstractOperableAST<?, ?> rightSideAST = this.parseLogicalOr(syntaxAnalyzer);
    ...
    // 9. logical OR (||)
    private AbstractOperableAST<?, ?> parseLogicalOr(final SyntaxAnalyzer syntaxAnalyzer) {
        AbstractOperableAST<?, ?> leftSideAST = this.parseLogicalAnd(syntaxAnalyzer);
        if (leftSideAST == null)
            return null;
        ...
        if (syntaxAnalyzer.matchesPeekToken(1, SymbolToken.SymbolType.VERTICAL_BAR) != null && syntaxAnalyzer.matchesPeekToken(2, SymbolToken.SymbolType.VERTICAL_BAR) != null) {
            ...
            final AbstractOperableAST<?, ?> rightSideAST = this.parseLogicalAnd(syntaxAnalyzer);
            if (rightSideAST == null)
                return null;
    ...
    // 8. logical AND (&&)
    private AbstractOperableAST<?, ?> parseLogicalAnd(final SyntaxAnalyzer syntaxAnalyzer) {
        AbstractOperableAST<?, ?> leftSideAST = this.parseEquality(syntaxAnalyzer);
        if (leftSideAST == null)
            return null;
        ...
        if (syntaxAnalyzer.matchesPeekToken(1, SymbolToken.SymbolType.AMPERSAND) != null && syntaxAnalyzer.matchesPeekToken(2, SymbolToken.SymbolType.AMPERSAND) != null) {
            ...
            final AbstractOperableAST<?, ?> rightSideAST = this.parseEquality(syntaxAnalyzer);
            if (rightSideAST == null)
                return null;
    ...
    // 7. equality (== !=)
    private AbstractOperableAST<?, ?> parseEquality(final SyntaxAnalyzer syntaxAnalyzer) {
        AbstractOperableAST<?, ?> leftSideAST = this.parseRelational(syntaxAnalyzer);
        if (leftSideAST == null)
            return null;
        ...
        if (syntaxAnalyzer.matchesPeekToken(1, SymbolToken.SymbolType.EQUAL) != null && syntaxAnalyzer.matchesPeekToken(2, SymbolToken.SymbolType.EQUAL) != null) {
            ...
            final AbstractOperableAST<?, ?> rightSideAST = this.parseRelational(syntaxAnalyzer);
            if (rightSideAST == null)
                return null;
    ...
    // 6. relational (< > <= >= is)
    private AbstractOperableAST<?, ?> parseRelational(final SyntaxAnalyzer syntaxAnalyzer) {
        AbstractOperableAST<?, ?> leftSideAST = this.parseAdditive(syntaxAnalyzer);
        if (leftSideAST == null)
            return null;
        ...
        if (syntaxAnalyzer.matchesPeekToken(1, SymbolToken.SymbolType.LESS_THAN_SIGN) != null && equal_second) {
            ...
            final AbstractOperableAST<?, ?> rightSideAST = this.parseAdditive(syntaxAnalyzer);
            if (rightSideAST == null)
                return null;
    ...
    // 5. additive (+ -)
    private AbstractOperableAST<?, ?> parseAdditive(final SyntaxAnalyzer syntaxAnalyzer) {
        AbstractOperableAST<?, ?> leftSideAST = this.parseMultiplicative(syntaxAnalyzer);
        if (leftSideAST == null)
            return null;
        ...
        if (syntaxAnalyzer.matchesPeekToken(1, SymbolToken.SymbolType.PLUS) != null) {
            ...
            final AbstractOperableAST<?, ?> rightSideAST = this.parseMultiplicative(syntaxAnalyzer);
            if (rightSideAST == null)
                return null;
    ...
    // 4. multiplicative (* / %)
    private AbstractOperableAST<?, ?> parseMultiplicative(final SyntaxAnalyzer syntaxAnalyzer) {
        AbstractOperableAST<?, ?> leftSideAST = this.parseUnary(syntaxAnalyzer);
        if (leftSideAST == null)
            return null;
        ...
        if (syntaxAnalyzer.matchesPeekToken(1, SymbolToken.SymbolType.ASTERISK) != null) {
            ...
            final AbstractOperableAST<?, ?> rightSideAST = this.parseUnary(syntaxAnalyzer);
            if (rightSideAST == null)
                return null;
    ...
    // 3. prefix (++expr --expr +expr -expr ~expr !expr)
    private AbstractOperableAST<?, ?> parseUnary(final SyntaxAnalyzer syntaxAnalyzer) {
        if (syntaxAnalyzer.matchesCurrentToken(SymbolToken.SymbolType.PLUS) != null && syntaxAnalyzer.matchesPeekToken(1, SymbolToken.SymbolType.PLUS) != null) {
            ...
            final AbstractOperableAST<?, ?> rightSideAST = this.parseParenthesis(syntaxAnalyzer);
            if (rightSideAST == null)
                return null;
    ...
    // 2. postfix (expr++ expr--)
    private AbstractOperableAST<?, ?> parsePostfix(final SyntaxAnalyzer syntaxAnalyzer) {
        AbstractOperableAST<?, ?> leftSideAST = this.parseParenthesis(syntaxAnalyzer);
        if (leftSideAST == null)
            return null;
    ...
    // 1. parenthesis ( (expr) )
    private AbstractOperableAST<?, ?> parseParenthesis(final SyntaxAnalyzer syntaxAnalyzer) {
