...
public class ImportDefinitionSemanticAST extends AbstractSemanticAST<ImportDefinitionSyntaxAST>
{
    ...
    public ImportDefinitionSemanticAST(final AbstractSemanticAST<?> lastContainerAST, final ImportDefinitionSyntaxAST importDefinitionSyntaxAST) {
        super(lastContainerAST, importDefinitionSyntaxAST, ASTType.IMPORT_DEFINITION);
    }
    
    @Override
    public ImportDefinitionSemanticAST analyse(final SemanticAnalyzer semanticAnalyzer) {
        return null;
    }
