 ...
 */
public class ImportDefinitionSemantic extends AbstractSemantic<ImportDefinitionAST>
{
    
    public ImportDefinitionSemantic(final ImportDefinitionAST importDefinitionAST) {
        super(importDefinitionAST);
    }
