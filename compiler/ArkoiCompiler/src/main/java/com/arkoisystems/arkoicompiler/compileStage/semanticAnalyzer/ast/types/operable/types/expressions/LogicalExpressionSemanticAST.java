...
import com.arkoisystems.arkoicompiler.compileStage.syntaxAnalyzer.ast.types.operable.types.expression.types.LogicalExpressionSyntaxAST;
...
@Getter
@Setter
public class LogicalExpressionSemanticAST extends AbstractOperableSemanticAST<LogicalExpressionSyntaxAST, TypeSyntaxAST.TypeKind>
{
    
    public LogicalExpressionSemanticAST(final AbstractSemanticAST<?> lastContainerAST, final LogicalExpressionSyntaxAST logicalExpressionSyntaxAST) {
        super(lastContainerAST, logicalExpressionSyntaxAST, ASTType.LOGICAL_EXPRESSION);
    }
    
    @Override
    public LogicalExpressionSemanticAST analyse(final SemanticAnalyzer semanticAnalyzer) {
        return null;
    }
