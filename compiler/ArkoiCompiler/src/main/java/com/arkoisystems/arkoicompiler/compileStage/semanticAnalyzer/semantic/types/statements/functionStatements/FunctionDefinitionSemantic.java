package com.arkoisystems.arkoicompiler.compileStage.semanticAnalyzer.semantic.types.statements.functionStatements;
...
public class FunctionDefinitionSemantic extends AbstractSemantic<FunctionDefinitionAST>
{
    ...
    public FunctionDefinitionSemantic(final FunctionDefinitionAST functionDefinitionAST) {
        super(functionDefinitionAST);
    }
