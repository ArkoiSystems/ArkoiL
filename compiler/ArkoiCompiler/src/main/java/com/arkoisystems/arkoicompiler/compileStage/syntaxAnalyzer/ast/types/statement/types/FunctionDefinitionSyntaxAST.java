...
public class FunctionDefinitionSyntaxAST extends AbstractStatementSyntaxAST
{
    ...
    @Expose
    private List<AnnotationSyntaxAST> functionAnnotationSyntaxASTS;
    
    @Expose
    private IdentifierToken functionNameToken;
    
    @Expose
    private TypeSyntaxAST functionReturnTypeSyntaxAST;
    
    @Expose
    private List<ArgumentDefinitionSyntaxAST> functionArgumentASTs;
    
    @Expose
    private BlockSyntaxAST blockSyntaxAST;
     ...
     *
     * @param functionAnnotationSyntaxASTS
     *         The annotation list which got parsed already.
     */
    public FunctionDefinitionSyntaxAST(final List<AnnotationSyntaxAST> functionAnnotationSyntaxASTS) {
        super(ASTType.FUNCTION_DEFINITION);
        
        this.functionAnnotationSyntaxASTS = functionAnnotationSyntaxASTS;
    ...
    public FunctionDefinitionSyntaxAST() {
        ...
        this.functionAnnotationSyntaxASTS = new ArrayList<>();
        this.functionArgumentASTs = new ArrayList<>();
    }
    ...
    public FunctionDefinitionSyntaxAST parseAST(final AbstractSyntaxAST parentAST, final SyntaxAnalyzer syntaxAnalyzer) {
        ...
        if (TypeSyntaxAST.TYPE_PARSER.canParse(this, syntaxAnalyzer)) {
            ...
            if (typeSyntaxAST == null) {
                ...
                this.functionReturnTypeSyntaxAST = typeSyntaxAST;
                syntaxAnalyzer.nextToken();
            }
        } else this.functionReturnTypeSyntaxAST = new TypeSyntaxAST(TypeSyntaxAST.TypeKind.VOID, false);
        ...
        ArgumentDefinitionSyntaxAST.parseArguments(this, syntaxAnalyzer, this.functionArgumentASTs);
        ...
        if (this.hasAnnotation("native")) {
            if (syntaxAnalyzer.matchesCurrentToken(SymbolToken.SymbolType.SEMICOLON) == null) {
                ...
                return null;
            } else this.blockSyntaxAST = new BlockSyntaxAST();
        } else {
            ...
            if ((this.blockSyntaxAST = BlockSyntaxAST.BLOCK_PARSER.parse(this, syntaxAnalyzer)) == null) {
            ...
            if (this.blockSyntaxAST.getBlockType() == BlockSyntaxAST.BlockType.INLINE && syntaxAnalyzer.matchesCurrentToken(SymbolToken.SymbolType.SEMICOLON) == null) {
                ...
                return null;
            } else if (this.blockSyntaxAST.getBlockType() == BlockSyntaxAST.BlockType.BLOCK && syntaxAnalyzer.matchesCurrentToken(SymbolToken.SymbolType.CLOSING_BRACE) == null) {
    ...
    public boolean hasAnnotation(final String annotationName) {
        for (final AnnotationSyntaxAST annotationSyntaxAST : this.functionAnnotationSyntaxASTS)
