            ...
            for (final AbstractParser<?> abstractParser : ROOT_PARSERS) {
                ...
                if (abstractSyntaxAST != null) {
                    if (abstractSyntaxAST instanceof FunctionDefinitionSyntaxAST) {
                        ...
                        if (functionDefinitionAST.getBlockSyntaxAST().getBlockType() == BlockSyntaxAST.BlockType.INLINE && syntaxAnalyzer.matchesCurrentToken(SymbolToken.SymbolType.SEMICOLON) == null) {
                            ...
                            return null;
                        } else if (functionDefinitionAST.getBlockSyntaxAST().getBlockType() == BlockSyntaxAST.BlockType.BLOCK && syntaxAnalyzer.matchesCurrentToken(SymbolToken.SymbolType.CLOSING_BRACE) == null) {
