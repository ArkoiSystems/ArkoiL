...
public class IdentifierInvokeOperableSemanticAST extends AbstractOperableSemanticAST<IdentifierInvokeOperableSyntaxAST, TypeSyntaxAST.TypeKind>
{
    ...
    public IdentifierInvokeOperableSemanticAST(final AbstractSemanticAST<?> lastContainerAST, final IdentifierInvokeOperableSyntaxAST identifierInvokeOperableSyntaxAST) {
        super(lastContainerAST, identifierInvokeOperableSyntaxAST, ASTType.IDENTIFIER_INVOKE_OPERABLE);
    }
    
    @Override
    public IdentifierInvokeOperableSemanticAST analyse(final SemanticAnalyzer semanticAnalyzer) {
        return null;
    }
