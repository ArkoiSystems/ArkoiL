...
public class TypeSemanticAST extends AbstractSemanticAST<TypeSyntaxAST>
{
    ...
    public TypeSemanticAST(final AbstractSemanticAST<?> lastContainerAST, final TypeSyntaxAST typeSyntaxAST) {
        super(lastContainerAST, typeSyntaxAST, ASTType.TYPE);
    }
    
    @Override
    public TypeSemanticAST analyse(final SemanticAnalyzer semanticAnalyzer) {
        return null;
    }
