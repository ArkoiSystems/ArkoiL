...
import com.arkoisystems.arkoicompiler.compileStage.syntaxAnalyzer.ast.types.operable.types.expression.types.RelationalExpressionAST;
...
public class RelationalExpressionSemantic extends AbstractSemantic<RelationalExpressionAST>
{
    ...
    public boolean analyse(final SemanticAnalyzer semanticAnalyzer) {
        ...
        switch (this.getAbstractAST().getRelationalOperator()) {
            case GREATER_EQUAL_THAN:
                resultKind = this.getAbstractAST().getLeftSideAST().relationalGreaterEqualThan(semanticAnalyzer, this.getAbstractAST().getRightSideAST());
                break;
            case GREATER_THAN:
                resultKind = this.getAbstractAST().getLeftSideAST().relationalGreaterThan(semanticAnalyzer, this.getAbstractAST().getRightSideAST());
                break;
            case LESS_EQUAL_THAN:
                resultKind = this.getAbstractAST().getLeftSideAST().relationalLessEqualThan(semanticAnalyzer, this.getAbstractAST().getRightSideAST());
                break;
            case LESS_THAN:
                resultKind = this.getAbstractAST().getLeftSideAST().relationalLessThan(semanticAnalyzer, this.getAbstractAST().getRightSideAST());
                break;
            case IS:
                resultKind = this.getAbstractAST().getLeftSideAST().relationalIs(semanticAnalyzer, this.getAbstractAST().getRightSideAST());
                break;
            default:
                resultKind = null;
                break;
