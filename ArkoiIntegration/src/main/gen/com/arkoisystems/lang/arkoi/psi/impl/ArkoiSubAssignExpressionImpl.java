...
public class ArkoiSubAssignExpressionImpl extends ASTWrapperPsiElement implements ArkoiSubAssignExpression {

  public ArkoiSubAssignExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArkoiVisitor visitor) {
    visitor.visitSubAssignExpression(this);
  }
