...
public class ArkoiBinaryAddExpressionImpl extends ASTWrapperPsiElement implements ArkoiBinaryAddExpression {

  public ArkoiBinaryAddExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArkoiVisitor visitor) {
    visitor.visitBinaryAddExpression(this);
  }
