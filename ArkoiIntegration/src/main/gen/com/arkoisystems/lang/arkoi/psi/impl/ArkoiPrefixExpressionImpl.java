...
public class ArkoiPrefixExpressionImpl extends ASTWrapperPsiElement implements ArkoiPrefixExpression {

  public ArkoiPrefixExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
