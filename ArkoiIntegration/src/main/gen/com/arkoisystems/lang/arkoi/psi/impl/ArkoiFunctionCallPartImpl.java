...
public class ArkoiFunctionCallPartImpl extends ASTWrapperPsiElement implements ArkoiFunctionCallPart {

  public ArkoiFunctionCallPartImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArkoiVisitor visitor) {
    visitor.visitFunctionCallPart(this);
  }
