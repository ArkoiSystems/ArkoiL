...
public class ArkoiBlockDeclarationImpl extends ASTWrapperPsiElement implements ArkoiBlockDeclaration {

  public ArkoiBlockDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArkoiVisitor visitor) {
    visitor.visitBlockDeclaration(this);
  }
