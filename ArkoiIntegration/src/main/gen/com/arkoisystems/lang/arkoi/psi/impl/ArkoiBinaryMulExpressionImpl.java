...
public class ArkoiBinaryMulExpressionImpl extends ASTWrapperPsiElement implements ArkoiBinaryMulExpression {

  public ArkoiBinaryMulExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArkoiVisitor visitor) {
    visitor.visitBinaryMulExpression(this);
  }
