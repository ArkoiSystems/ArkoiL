...
public class ArkoiInlinedBlockImpl extends ASTWrapperPsiElement implements ArkoiInlinedBlock {

  public ArkoiInlinedBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArkoiVisitor visitor) {
    visitor.visitInlinedBlock(this);
  }
