...
public class ArkoiModAssignExpressionImpl extends ASTWrapperPsiElement implements ArkoiModAssignExpression {

  public ArkoiModAssignExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArkoiVisitor visitor) {
    visitor.visitModAssignExpression(this);
  }
