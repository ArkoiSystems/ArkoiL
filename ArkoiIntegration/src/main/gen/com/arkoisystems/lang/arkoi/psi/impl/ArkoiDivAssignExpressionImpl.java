...
public class ArkoiDivAssignExpressionImpl extends ASTWrapperPsiElement implements ArkoiDivAssignExpression {

  public ArkoiDivAssignExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArkoiVisitor visitor) {
    visitor.visitDivAssignExpression(this);
  }
