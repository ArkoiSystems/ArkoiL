...
public class ArkoiBinarySubExpressionImpl extends ASTWrapperPsiElement implements ArkoiBinarySubExpression {

  public ArkoiBinarySubExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArkoiVisitor visitor) {
    visitor.visitBinarySubExpression(this);
  }
