...
public class ArkoiBinaryModExpressionImpl extends ASTWrapperPsiElement implements ArkoiBinaryModExpression {

  public ArkoiBinaryModExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArkoiVisitor visitor) {
    visitor.visitBinaryModExpression(this);
  }
