...
public class ArkoiMulAssignExpressionImpl extends ASTWrapperPsiElement implements ArkoiMulAssignExpression {

  public ArkoiMulAssignExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArkoiVisitor visitor) {
    visitor.visitMulAssignExpression(this);
  }
